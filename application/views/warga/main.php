                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="#/pengajuan" class="waves-effect"><i class="mdi mdi-file"></i><span> Pengajuan </span></a>
                            </li>
                            <li>
                                <a href="#/profile_keluarga" class="waves-effect"><i class="mdi mdi-account"></i><span> Profile Keluarga </span></a>
                            </li>
                        </ul>
                    </div>

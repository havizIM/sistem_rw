<div class="">
    <div class="page-header-title">
        <h4 class="page-title">Surat Kematian</h4>
    </div>
</div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-wrap" id="t_kematian">
                            <thead>
                                <tr>
                                <th class="w-1">No.</th>
                                <th>No Surat</th>
...
<script type="text/javascript">
  ...
  {
    $.ajax({
      url: '<?= base_url().'api/select_kematian' ?>',
      type: 'GET',
      dataType: 'JSON',
      success: function(data){
        ...
        if(data.ktp.length != 0){
          ...
          html += `<tr><td colspan="6" align="center">Tidak ada Pengajuan Surat Kematian</td></tr>`;
        }

        $('#t_kematian tbody').html(html);
      },
      error: function(){

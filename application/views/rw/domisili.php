<div class="">
    <div class="page-header-title">
        <h4 class="page-title">Surat Domisili</h4>
    </div>
</div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-wrap" id="t_domisili">
                            <thead>
                                <tr>
                                <th class="w-1">No.</th>
                                <th>No Surat</th>
...
<script type="text/javascript">
  ...
  {
    $.ajax({
      url: '<?= base_url().'api/select_domisili' ?>',
      type: 'GET',
      dataType: 'JSON',
      success: function(data){
        ...
        if(data.ktp.length != 0){
          ...
          html += `<tr><td colspan="6" align="center">Tidak ada Pengajuan Surat Domisili</td></tr>`;
        }

        $('#t_domisili tbody').html(html);
      },
      error: function(){
